...
<p align="center">
  <span align="center">Uma ferramenta desenvolvida para solucionar problemas na Design Cursos</span>
</p>
<h4 align="center">
...
### 1. Instalar Office
Executa o arquivo de Setup que contém dentro do arquivo ISO do Office (É a ISO oficial do Office 2021), deve ser aguardada a conclusão da instalação, com o Office instalado, o usuário deve pressionar qualquer botão para continuar para as outras etapas.
...
### 4. Instalar Adobe
Copia uma pasta que contém os Aplicativos Adobe pré-instalados, deixando tudo pronto para rodar. Após tudo copiado, abre uma janela de instalação do photoshop, o único que precisa ser instalado manualmente, basta confirmar a pasta de destino e será instalado.  \
...
**User:** Cria um usuário "Admin" como Administrador, e define o usuário "Design" (dos alunos) para um grupo de usuário padrão, ou seja, remove os privilégios de Administrador dos alunos.  \
  \
...
· Define um DNS fixo na máquina, esse DNS impede que os alunos acessem conteúdos adultos e inadequados.  \
