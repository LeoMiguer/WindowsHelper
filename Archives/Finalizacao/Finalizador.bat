...
start /wait D:\Archives\Finalizacao\ForceWallpaper.bat

xcopy /h /y "D:\Archives\Finalizacao\WallpaperDesign.png" "C:\Users\%username%\"

xcopy /h /y "D:\Archives\Finalizacao\ForceWallpaper.bat" "C:\Users\%username%\"
...
mklink "%userprofile%\Desktop\Photoshop" "C:\Program Files\Adobe\Adobe Photoshop 2025\Photoshop.exe"
if exist "%userprofile%\OneDrive\Desktop" (
mklink "%userprofile%\OneDrive\Desktop\Photoshop" "C:\Program Files\Adobe\Adobe Photoshop 2025\Photoshop.exe"
)
